...
from src.automation.sgf.resumen_rend_prov import ResumenRendProv
...
def run():
    ...
    print("🚀 Iniciando automatización SGF Resumen Rendiciones Proveedores...")

    save_path = Path(
        os.path.join(get_download_sgf_path(), "Resumen de Rendiciones Proveedores")
    )
        ...
        with login(username, password) as conn:
            ...
            for origen in origenes:
                ...
                for ejercicio in ejercicios:
                    ...
                    resumen_rend.add_cuit_from_desc_prov(token=token)
