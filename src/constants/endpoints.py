...
class Endpoints(str, Enum):
    ...
    CONTROL_HONORARIOS = "/control/controlHonorarios"
    ...
    REPORTE_FORMULACION_CARGA = "/reporte/reporteFormulacion/carga"
    REPORTE_FORMULACION_GASTOS = "/reporte/reporteFormulacion/gastos"
    REPORTE_FORMULACION_RECURSOS = "/reporte/reporteFormulacion/recursos"
