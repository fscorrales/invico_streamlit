...
from src.services import get_ejercicios, get_siif_rci02, post_request
...
ENDPONT = Endpoints.SIIF_RCI02.value
REPORTE = "rci02"
...
async def run_automation(username: str, password: str, reporte: str) -> None:
    ...
    async with async_playwright() as p:
        ...
        for ej in ejercicios:
            await siif.download_and_process_report(ejercicio=ej)
