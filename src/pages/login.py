                ...
                if submitted:
                    try:
                        ...
                        with st.status(
                            ...
                            st.write("Sincronizando Grupos Partidas SIIF...")
                            if (
                                "grupos_partidas_siif_uploader_iteration"
                                not in st.session_state
                            ):
                            ...
                            st.write("Sincronizando Partidas Principales SIIF...")
                            if (
                                "partidas_principales_siif_uploader_iteration"
                                not in st.session_state
                            ):
