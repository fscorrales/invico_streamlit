...
from src.services import get_control_banco_cruzado, get_ejercicios
...
ENDPONT = Endpoints.CONTROL_BANCO_CRUZADO.value
REPORTE = "control_banco_cruzado"
...
def render(
    ...
    if not df.empty:
        ...
        dataframe(
            df,
            key=f"{REPORTE}_df_control_banco_cruzado",
