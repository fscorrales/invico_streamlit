...
from src.services import get_control_obras, get_ejercicios
from src.utils import (
    APIConnectionError,
    APIResponseError,
)
from src.views import report_template, request_siif_and_sgf_credentials_modal
...
def render() -> None:
    ...
    if not df.empty:
        ...
        dataframe(
            df,
            key=f"{REPORTE}_df_control_obras",
