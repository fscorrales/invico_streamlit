...
Date   : 05-ago-2026
Purpose: Migrate SIIF's ri102 () from SQLite to MongoDB
"""

__all__ = ["sync_ri102_to_mongodb"]
...
def get_args():
    ...
    parser = argparse.ArgumentParser(
        description="Migrate SIIF's ri102 () from SQLite to MongoDB",
...
# --------------------------------------------------
def sync_ri102_to_mongodb(sqlite_path: str, endpoint: str) -> None:
    """Download, process and sync the ri102 report to the repository."""
    try:
...
def main():
    ...
    sync_ri102_to_mongodb(
        sqlite_path=args.sqlite_path,
        endpoint=Endpoints.SIIF_RI102.value,
    )
...
if __name__ == "__main__":
    ...
    # poetry run python -m src.migration.siif.ri102 -s "D:\Datos INVICO\IT\Python\Python Output\SQLite Files\siif.sqlite"
